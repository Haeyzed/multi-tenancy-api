...
return [
    ...
    /*
     * Central activity model. Always writes to the central database.
     * Tenant requests swap to tenant_models via SpatieActivitylogBootstrapper.
     */
    'activity_model' => CentralActivity::class,

    'central_models' => [
        'activity' => CentralActivity::class,
    ],

    'tenant_models' => [
        'activity' => TenantActivity::class,
    ],
