...
/**
 * Validates incoming data for updating an existing tenant payment method.
 */
class UpdatePaymentMethodRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            /**
             * UUID of the tenant that owns this payment method; optional on update.
             *
            ...
            /**
             * Payment gateway that tokenized this method; optional on update.
             *
             * @var string $provider
             *
             * @example "stripe"
             */
            'provider' => 'sometimes|string|in:stripe,paddle,paypal',

            /**
             * External payment method identifier from the provider; optional on update.
             *
            ...
            /**
             * Kind of payment method stored; optional on update.
             *
             * @var string $type
             *
             * @example "card"
             */
            'type' => 'sometimes|string|in:card,bank_account,wallet',
