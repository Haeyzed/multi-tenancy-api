...
/**
 * Validates incoming data for creating a new tenant domain.
 */
class StoreDomainRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            /**
             * UUID of the tenant that owns this domain.
             *
            ...
            /**
             * Fully qualified domain name; must be unique across all tenants.
             *
             * @var string $domain
             *
