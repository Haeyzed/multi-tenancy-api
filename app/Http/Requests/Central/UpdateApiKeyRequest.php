...
/**
 * Validates incoming data for updating an existing tenant API key.
 */
class UpdateApiKeyRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            /**
             * UUID of the tenant that owns this API key; optional on update.
             *
            ...
            /**
             * Human-readable label for the API key; optional on update.
             *
             * @var string $name
             *
            ...
            /**
             * Hashed value of the API key secret; optional on update.
             *
             * @var string $key_hash
             *
             * @example "$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi"
             */
            'key_hash' => 'sometimes|string',
